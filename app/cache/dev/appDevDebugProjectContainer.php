...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'bacon_doodle', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_413db9712a93ccf76f255aa6f1101f50bd9c75298f02066a27fe984915c66d65');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('a5e0629c38952bc7a31a63c92bfc33795a950dbb');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('561ecb938e13b5.92738655')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'secret' => 'a5e0629c38952bc7a31a63c92bfc33795a950dbb',
            'locale' => 'en',
            ...
            'kernel.secret' => 'a5e0629c38952bc7a31a63c92bfc33795a950dbb',
            ...
            'assetic.ruby.bin' => 'C:\\Programming\\Heroku\\ruby-1.9.3\\bin\\ruby.EXE',
